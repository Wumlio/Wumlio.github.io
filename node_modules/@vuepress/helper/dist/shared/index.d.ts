 ...
 */
export declare const deepAssign: <OriginType extends IAnyObject, MergeType extends IAnyObject = OriginType, FinalType extends Partial<OriginType> & Partial<MergeType> = OriginType & MergeType>(originObject: OriginType, ...overrideObjects: (MergeType | null | undefined)[]) => FinalType;
//#endregion
 ...
 */
export declare const isArray: <ItemType>(val: unknown) => val is ItemType[];
/**
...
export declare const keys: <ObjectType extends object>(obj: ObjectType) => `${keyof ObjectType & (string | number | boolean | null | undefined)}`[];
...
//#endregion
export { type DeepRequired, type ExactLocaleConfig, type GetHeadersOptions, type HeaderLevels, type KeyOptions, type LiteralUnion, type UnionToIntersection, ensureEndingSlash, ensureLeadingSlash, isFunction, isLinkExternal, isLinkHttp, isLinkWithProtocol, isPlainObject, isString, removeEndingSlash, removeLeadingSlash };
