 ...
 */
export declare const LoadingIcon: FunctionalComponent<LoadingIconProps>;
//#endregion
 ...
 */
export declare const RenderDefault: FunctionalComponent<Record<never, never>, Record<never, never>, {
...
export declare const encodeSVG: (svg: string) => string;
//#endregion
 ...
 */
export declare const getDarkMode: () => boolean;
//#endregion
 ...
 */
export declare const useLocaleConfig: <Locale extends LocaleData>(localesConfig: MaybeRef<ExactLocaleConfig<Locale>>) => ComputedRef<Locale>;
/**
 * Short alias of `useLocaleConfig`
 *
 * `useLocaleConfig` 的简短别名
 */
export declare const useLocale: <Locale extends LocaleData>(localesConfig: MaybeRef<ExactLocaleConfig<Locale>>) => ComputedRef<Locale>;
//#endregion
...
//#endregion
export { type DeepRequired, type ExactLocaleConfig, type GetHeadersOptions, type HeaderLevels, type KeyOptions, type LiteralUnion, type RequiredSlot, type RequiredSlotContent, type SingleSlot, type SingleSlotContent, type Slot, type SlotContent, type UnionToIntersection, dateSorter, deepAssign, endsWith, ensureEndingSlash, ensureLeadingSlash, entries, fromEntries, getDate, isArray, isBoolean, isDef, isFunction, isLinkAbsolute, isLinkExternal, isLinkHttp, isLinkRelative, isLinkWithProtocol, isNumber, isPlainObject, isRegExp, isString, keys, normalizePath, removeEndingSlash, removeLeadingSlash, startsWith, values };
