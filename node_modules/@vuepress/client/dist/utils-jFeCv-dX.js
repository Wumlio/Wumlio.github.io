...
*/
const resolveClientDataSymbol = () => {
	globalThis[CLIENT_DATA_SYMBOL_GLOBAL_KEY] ??= Symbol("clientData");
	return globalThis[CLIENT_DATA_SYMBOL_GLOBAL_KEY];
};
/**
...
*/
const clientDataSymbol = __VUEPRESS_DEV__ ? resolveClientDataSymbol() : Symbol("");
/**
* Returns client data
*/
const useClientData = () => {
...
//#endregion
export { useRouteLocale as A, usePageComponent as C, usePageLang as D, usePageHead as E, useSiteLocale as F, useSiteLocaleData as I, clientDataSymbol as L, useRoutes as M, useSite as N, usePageLayout as O, useSiteData as P, useClientData as R, usePage as S, usePageFrontmatter as T, useData as _, AutoLink as a, useLang as b, useRouter$1 as c, resolveRoutePath as d, redirects$1 as f, onContentUpdated as g, useUpdateHead as h, ClientOnly as i, useRoutePath as j, useRedirects as k, resolveRouteFullPath as l, updateHeadSymbol as m, resolvers as n, RouteLink as o, routes$1 as p, Content as r, useRoute$1 as s, withBase as t, resolveRoute as u, useFrontmatter as v, usePageData as w, useLayouts as x, useHead as y };
