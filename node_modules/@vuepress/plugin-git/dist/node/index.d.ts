import { a as GitInjectOptions, c as GitPluginPageData, d as SubmoduleInfo, i as GitData, l as GitUrlPattern, n as GitChangelogInfo, o as GitLocaleData, r as GitContributorInfo, s as GitPluginFrontmatter, t as CoAuthorInfo, u as KnownGitProvider } from "../index-CIK8jUmh.js";
 ...
 *   a git repository
 */
export declare const getGitRepoRoot: (filePath: string, cwd: string) => Promise<string | null>;
/**
...
export declare const clearGitRepoRootCache: () => void;
//#endregion
...
export declare const getUserNameWithNoreplyEmail: (email: string) => string | null;
//#endregion
...
export declare const PLUGIN_NAME = "@vuepress/plugin-git";
...
//#endregion
export type { ChangelogOptions, CoAuthorInfo, ContributorInfo, ContributorsOptions, GitChangelogInfo, GitContributorInfo, GitData, GitInjectOptions, GitLocaleData, GitPluginFrontmatter, GitPluginOptions, GitPluginPageData, GitUrlPattern, KnownGitProvider, MergedRawCommit, RawCommit, SubmoduleInfo };
