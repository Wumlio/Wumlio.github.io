 ...
 *   }
 */
export declare const palettePlugin: ({ preset, userPaletteFile, tempPaletteFile, importCode }?: PalettePluginOptions) => Plugin;
//#endregion
 ...
 */
export declare const preparePaletteFile: (app: App, { userPaletteFile, tempPaletteFile, importCode }: Pick<Required<PalettePluginOptions>, "importCode" | "tempPaletteFile" | "userPaletteFile">) => Promise<string>;
//#endregion
