...
export declare const DEFAULT_LOCALE_OPTIONS: DefaultThemeLocaleOptions;
export declare const DEFAULT_LOCALE_DATA: DefaultThemeLocaleData;
/**
 * Assign default options
 *
 * @param localeOptions - Locale options to assign default options
 */
export declare const assignDefaultLocaleOptions: (localeOptions: DefaultThemeLocaleOptions) => void;
//#endregion
...
//#endregion
export type { AutoLinkOptions, DefaultThemeData, DefaultThemeHomePageFrontmatter, DefaultThemeLocaleData, DefaultThemeLocaleOptions, DefaultThemeNormalPageFrontmatter, DefaultThemePageData, DefaultThemePageFrontmatter, DefaultThemePluginsOptions, NavGroup, NavItemOptions, NavbarGroupOptions, NavbarLinkOptions, NavbarOptions, SidebarArrayOptions, SidebarGroupOptions, SidebarItemOptions, SidebarLinkOptions, SidebarObjectOptions, SidebarOptions };
