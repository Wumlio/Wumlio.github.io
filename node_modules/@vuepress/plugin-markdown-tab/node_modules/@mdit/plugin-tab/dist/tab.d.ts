 ...
 */
export declare const register: ({ name }?: TabOptions) => void;
/**
 ...
 * @param options - Options / 选项
 */
export declare const destroy: ({ name }?: TabOptions) => void;
/**
 ...
 * @param options - Options / 选项
 */
export declare const refresh: (options?: TabOptions) => void;
//#endregion
