 ...
 */
export declare const highlightPlugin: (md: Markdown, { highlightLines, notationDiff: enabledDiff, notationErrorLevel: enabledErrorLevel, notationFocus: enabledFocus, notationHighlight: enabledHighlight, notationWordHighlight: enabledWordHighlight, whitespace: whitespacePosition }?: MarkdownItPrismjsHighlightOptions) => void;
//#endregion
 ...
 * @param options - Plugin options / 插件选项
 */
export declare const preWrapperPlugin: (md: Markdown, { preWrapper }?: MarkdownItPreWrapperOptions) => void;
//#endregion
 ...
 */
export declare const prismjsPlugin: (options?: PrismjsPluginOptions) => Plugin;
//#endregion
 ...
 */
export declare const getCodeParser: (html: string, lang?: string) => CodeParser;
//#endregion
 ...
 */
export declare const highlightWordInLine: (node: OpenTag, pattern: RegExp | string) => void;
/**
...
//#endregion
export type { PrismjsDarkTheme, PrismjsHighlightOptions, PrismjsLightTheme, PrismjsPluginOptions, PrismjsTheme };
